...
First, try:
	 Rscript cnRegionPlot.R -h

Download the example segment files and chromosome length files and try the following commands.

./all_in_one_script.r -S 1,2 ~/mkWES_rm_HighThreshold19/segment-log2-ratio.txt tst.png
./all_in_one_script.r -S 1,2 ~/mkWES_rm_HighThreshold19/segment-log2-ratio.txt tst2.png
./all_in_one_script.r -S 1,2 -c 1,2,X -s 0,0,0, -e 1000000,2000000,10000000 ~/mkWES_rm_HighThreshold19/segment-log2-ratio.txt tst3.png
./all_in_one_script.r -S 1,2 -c 1,2,X -s 0,0,0, -e 1000000,2000000,10000000 ~/mkWES_rm_HighThreshold19/segment-log2-ratio.txt tst4.png
